...
<template>
  ...
  <div class="max-w-3xl mx-auto p-6">
    ...
    <div class="bg-white shadow rounded p-4 space-y-4 dark:bg-gray-800 dark:text-gray-200">
      <div>
        ...
        <div class="flex items-center space-x-4">
          <label class="inline-flex items-center">
            ...
            <span class="ml-2" @click="toggleDarkMode()">Light</span>
          </label>
          <label class="inline-flex items-center">
            <input type="radio" v-model="theme" value="dark" class="form-radio" />
            <span class="ml-2" @click="toggleDarkMode()">Dark</span>
          </label>
        </div>
      </div>
